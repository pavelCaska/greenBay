package com.pc.greenbay.configs;

import com.pc.greenbay.filters.JwtAuthFilter;
import com.pc.greenbay.services.UserInfoUserDetailsService;
...
public class DefaultSecurityConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http,
        ...
        http.authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.GET,"/api/item/{id}")).hasAnyRole("USER", "ADMIN")
